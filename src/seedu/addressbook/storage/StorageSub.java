...
public class StorageSub extends Storage {
     ...
     */
    public StorageSub() throws InvalidStorageFilePathException {
     ...
     */
    public StorageSub(String filePath) throws InvalidStorageFilePathException {
        try {
